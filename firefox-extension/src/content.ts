...
// Adapted for Firefox with webextension-polyfill

// Import type uniquement, plus d'import de fonctions
import type { Session } from "./auth-client";

// Use webextension-polyfill with fallback to chrome for compatibility
...
async function getSessionFromBackground(): Promise<Session | null> {
  return new Promise((resolve) => {
    api.runtime.sendMessage({ type: "GET_SESSION" }, (response: any) => {
