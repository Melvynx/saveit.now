...
import { OGImageTool } from "@/components/tools/og-image-tool";

function OGImageToolPage() {
  return (
...
export const Route = createFileRoute("/tools/og-images")({
  component: OGImageToolPage,
});
