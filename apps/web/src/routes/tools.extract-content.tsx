...
import { ExtractContentTool } from "@/components/tools/extract-content-tool";

function ExtractContentToolPage() {
  return (
...
export const Route = createFileRoute("/tools/extract-content")({
  component: ExtractContentToolPage,
});
