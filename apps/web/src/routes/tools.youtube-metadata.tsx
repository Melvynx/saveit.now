...
import { YoutubeMetadataTool } from "@/components/tools/youtube-metadata-tool";

function YoutubeMetadataToolPage() {
  return (
...
export const Route = createFileRoute("/tools/youtube-metadata")({
  component: YoutubeMetadataToolPage,
});
