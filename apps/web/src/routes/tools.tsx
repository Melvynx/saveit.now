        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2">
          <div className="rounded-xl border border-[#2a2a2a] bg-[#1a1a1a] p-6">
            ...
            <p className="mt-3 text-sm leading-relaxed text-[#888]">
              We did not build these as side projects - they are the actual
              tools powering SaveIt.now's website analysis engine. Every day,
              they help us extract metadata, analyze content, and optimize our
              own systems.
            </p>
          </div>
          <div className="rounded-xl border border-[#2a2a2a] bg-[#1a1a1a] p-6">
