...
import { ExtractFaviconsTool } from "@/components/tools/extract-favicons-tool";

function ExtractFaviconsToolPage() {
  return (
...
export const Route = createFileRoute("/tools/extract-favicons")({
  component: ExtractFaviconsToolPage,
});
