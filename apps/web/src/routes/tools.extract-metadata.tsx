...
import { ExtractMetadataTool } from "@/components/tools/extract-metadata-tool";

function ExtractMetadataToolPage() {
  return (
...
export const Route = createFileRoute("/tools/extract-metadata")({
  component: ExtractMetadataToolPage,
});
