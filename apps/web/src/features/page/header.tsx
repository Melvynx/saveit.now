    ...
    <header className="border-b py-2 bg-background">
      <MaxWidthContainer className="flex items-center gap-2 px-4">
        ...
        <nav className="hidden md:flex items-center gap-6 ml-8">
          <a href="/tools" className="text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">
            Tools
          </a>
          ...
          <a href="/docs" className="text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">
            Docs
          </a>
        </nav>
