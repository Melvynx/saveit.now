...
export const env = createEnv({
  server: {
    ...
    TELEGRAM_TOKEN: z.string().min(1).default("ci-placeholder"),
    TELEGRAM_CHAT_ID: z.string().min(1).default("ci-placeholder"),
    SEARCH_API_KEY: z.string().min(1).default("ci-placeholder"),
  },
  client: {},
