---
name: ns-ios-notification
description: Set up iOS-oriented NowStack Mobile push notifications with Expo, Convex, EAS/APNs, settings, logs, admin tests, and TestFlight verification. Use for "notifications", "push", "ns ios notification", or "ns notification".
---

# ns-ios-notification - Push notifications for NowStack Mobile
