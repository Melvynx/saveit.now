...
/**
 * generateStructured — wrapper around generateObject using Gemini.
 */
...
// ---------------------------------------------------------------------------
// Prompt constants — VERBATIM from apps/web/src/lib/inngest/prompt.const.ts
// ---------------------------------------------------------------------------
...
export const IMAGE_ANALYSIS_PROMPT = `Analyze this screenshot and provide a detailed description of what you see. Focus on:
